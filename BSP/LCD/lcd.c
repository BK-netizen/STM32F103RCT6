...
void lcd_show_CN(uint16_t x, uint16_t y, char num, uint8_t size, uint16_t color)
{
    uint8_t temp, t1, t;
    uint16_t y0 = y;
    uint8_t *pfont = 0;
    ...
    {
        case 16:
            pfont = (uint8_t *)CN_1616[num];      /* 调用1608字体 */
            break;

        case 24:
            pfont = (uint8_t *)CN_2424[num];      /* 调用2412字体 */
            break;

        case 32:
            pfont = (uint8_t *)CN_3232[num];      /* 调用3216字体 */
            break;
